        ...
        <div className='border border-gray-400 p-2 mb-2'>
          ...
          <div className='flex gap-6'>
            ...
            <div className='flex items-center gap-2 py-1'>
              ...
              <input className='shadow-inner border w-[12rem]' type="text" disabled value={1}/>
            </div>
          </div>
          ...
          <div>
            <div className='flex items-center gap-2 py-1'>
              ...
              <input className='shadow-inner border' type="text" value={this.props.dataFormAffaire().libelle_affaire} disabled/>
            </div>
          </div>
          ...
          <div className='flex'>
            <div className='flex items-center gap-2 py-1'>
              ...
              <input className='shadow-inner border' type="text" value={this.props.dataFormAffaire().libelle_plan_affaire} disabled/>
            </div>
          </div>
